...
public final class CropImage {
    ...
    public static void startPickImageDirectly(@NonNull Activity activity) {
        Intent pickIntent = new Intent(Intent.ACTION_GET_CONTENT);
        pickIntent.setType("image/*");
        activity.startActivityForResult(pickIntent, PICK_IMAGE_CHOOSER_REQUEST_CODE);
    }
    ...
    public static final class ActivityBuilder {
        ...
        public ActivityBuilder pickWithoutChooser() {
            mOptions.cropSourceFlag = 1;
            return this;
        }

        public ActivityBuilder capturePhoto() {
            mOptions.cropSourceFlag = 2;
            return this;
        }
    }
    // endregion
